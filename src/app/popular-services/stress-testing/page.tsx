...
const page = () => {
  return (
    <main className="flex min-h-screen flex-col w-[1400px] max-w-full m-auto px-8 md:px-16 my-16 gap-4">
      {' '}
      <h1 className="text-2xl">STRESS TESTING</h1>
      <p>
        Stress testing your financial plan (or one you are considering
        implementing) can be a very smart way to help make certain that the plan
        will deliver as promised—and not deliver unintended consequences that
        can derail your financial security and comfort.
      </p>
      <div className="mt-4">
        {' '}
        <Link
