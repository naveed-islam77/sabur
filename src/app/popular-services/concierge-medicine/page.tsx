...
const page = () => {
  return (
    <main className="flex min-h-screen flex-col w-[1400px] max-w-full m-auto px-8 md:px-16 my-16 gap-4">
      {' '}
      <h1 className="text-2xl">CONCIERGE MEDICINE</h1>
      <p>
        Health is one of the most important concerns of everyone in the family.
        We have a Concierge Desk standing by to help you make connections with
